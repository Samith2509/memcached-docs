...
ssize_t tcp_read(struct conn *c, void *buf, size_t count) {
    ((void) sizeof (__assert_single_arg (c != ((void *)0))), __extension__ ({ if (c != ((void *)0)) ; else __assert_fail ("c != NULL", "testapp.c", 57, __extension__ __PRETTY_FUNCTION__); }));
    return read(c->sock, buf, count);
}
ssize_t tcp_write(struct conn *c, const void *buf, size_t count) {
    ((void) sizeof (__assert_single_arg (c != ((void *)0))), __extension__ ({ if (c != ((void *)0)) ; else __assert_fail ("c != NULL", "testapp.c", 62, __extension__ __PRETTY_FUNCTION__); }));
    return write(c->sock, buf, count);
}
ssize_t ssl_read(struct conn *c, void *buf, size_t count) {
    ((void) sizeof (__assert_single_arg (c != ((void *)0))), __extension__ ({ if (c != ((void *)0)) ; else __assert_fail ("c != NULL", "testapp.c", 67, __extension__ __PRETTY_FUNCTION__); }));
    return SSL_read(c->ssl, buf, count);
}
ssize_t ssl_write(struct conn *c, const void *buf, size_t count) {
    ((void) sizeof (__assert_single_arg (c != ((void *)0))), __extension__ ({ if (c != ((void *)0)) ; else __assert_fail ("c != NULL", "testapp.c", 72, __extension__ __PRETTY_FUNCTION__); }));
    return SSL_write(c->ssl, buf, count);
}
static pid_t server_pid;
static in_port_t port;
static struct conn *con = ((void *)0);
...
static enum test_return cache_create_test(void)
{
    ...
    ((void) sizeof (__assert_single_arg (cache != ((void *)0))), __extension__ ({ if (cache != ((void *)0)) ; else __assert_fail ("cache != NULL", "testapp.c", 101, __extension__ __PRETTY_FUNCTION__); }));
    cache_destroy(cache);
    return TEST_PASS;
}
static enum test_return cache_reuse_test(void)
{
    ...
    for (ii = 0; ii < 100; ++ii) {
        ...
        ((void) sizeof (__assert_single_arg (p == ptr)), __extension__ ({ if (p == ptr) ; else __assert_fail ("p == ptr", "testapp.c", 117, __extension__ __PRETTY_FUNCTION__); }));
        cache_free(cache, ptr);
    }
    cache_destroy(cache);
    return TEST_PASS;
...
static enum test_return cache_bulkalloc(size_t datasize)
{
    ...
    for (int ii = 0; ii < 1024; ++ii) {
        ...
        ((void) sizeof (__assert_single_arg (ptr[ii] != 0)), __extension__ ({ if (ptr[ii] != 0) ; else __assert_fail ("ptr[ii] != 0", "testapp.c", 136, __extension__ __PRETTY_FUNCTION__); }));
...
static enum test_return cache_redzone_test(void)
{
    ...
    struct sigaction action = { .__sigaction_handler.sa_handler = ((__sighandler_t) 1), .sa_flags = 0};
    sigemptyset(&action.sa_mask);
    sigaction(6, &action, &old_action);
    char *p = cache_alloc(cache);
    char old = *(p - 1);
    *(p - 1) = 0;
    cache_free(cache, p);
    ((void) sizeof (__assert_single_arg (cache_error == -1)), __extension__ ({ if (cache_error == -1) ; else __assert_fail ("cache_error == -1", "testapp.c", 178, __extension__ __PRETTY_FUNCTION__); }));
    *(p - 1) = old;
    p[sizeof(uint32_t)] = 0;
    cache_free(cache, p);
    ((void) sizeof (__assert_single_arg (cache_error == 1)), __extension__ ({ if (cache_error == 1) ; else __assert_fail ("cache_error == 1", "testapp.c", 183, __extension__ __PRETTY_FUNCTION__); }));
    sigaction(6, &old_action, ((void *)0));
    cache_destroy(cache);
    return TEST_PASS;
}
static enum test_return cache_limit_revised_downward_test(void)
{
    ...
    cache_t *cache = cache_create("test", sizeof(uint32_t), sizeof(char*));
    ((void) sizeof (__assert_single_arg (cache != ((void *)0))), __extension__ ({ if (cache != ((void *)0)) ; else __assert_fail ("cache != NULL", "testapp.c", 202, __extension__ __PRETTY_FUNCTION__); }));
    for (i = 0; i < allocated_num; i++) {
        alloc_objs[i] = cache_alloc(cache);
        ((void) sizeof (__assert_single_arg (alloc_objs[i] != ((void *)0))), __extension__ ({ if (alloc_objs[i] != ((void *)0)) ; else __assert_fail ("alloc_objs[i] != NULL", "testapp.c", 207, __extension__ __PRETTY_FUNCTION__); }));
    }
    ((void) sizeof (__assert_single_arg (cache->total == allocated_num)), __extension__ ({ if (cache->total == allocated_num) ; else __assert_fail ("cache->total == allocated_num", "testapp.c", 209, __extension__ __PRETTY_FUNCTION__); }));
    cache_set_limit(cache, limit);
    cache_free(cache, alloc_objs[0]);
    ((void) sizeof (__assert_single_arg (cache->total == allocated_num-1)), __extension__ ({ if (cache->total == allocated_num-1) ; else __assert_fail ("cache->total == allocated_num-1", "testapp.c", 217, __extension__ __PRETTY_FUNCTION__); }));
    cache_destroy(cache);
    free(alloc_objs);
    return TEST_PASS;
}
static enum test_return test_stats_prefix_find(void) {
    ...
    ((void) sizeof (__assert_single_arg (pfs1 == ((void *)0))), __extension__ ({ if (pfs1 == ((void *)0)) ; else __assert_fail ("pfs1 == NULL", "testapp.c", 230, __extension__ __PRETTY_FUNCTION__); }));
    pfs1 = stats_prefix_find("abc|", 4);
    ((void) sizeof (__assert_single_arg (pfs1 == ((void *)0))), __extension__ ({ if (pfs1 == ((void *)0)) ; else __assert_fail ("pfs1 == NULL", "testapp.c", 232, __extension__ __PRETTY_FUNCTION__); }));
    pfs1 = stats_prefix_find("abc:", 4);
    ((void) sizeof (__assert_single_arg (pfs1 != ((void *)0))), __extension__ ({ if (pfs1 != ((void *)0)) ; else __assert_fail ("pfs1 != NULL", "testapp.c", 235, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0ULL == (pfs1->num_gets + pfs1->num_sets + pfs1->num_deletes + pfs1->num_hits))), __extension__ ({ if (0ULL == (pfs1->num_gets + pfs1->num_sets + pfs1->num_deletes + pfs1->num_hits)) ; else __assert_fail ("0ULL == (pfs1->num_gets + pfs1->num_sets + pfs1->num_deletes + pfs1->num_hits)", "testapp.c", 236, __extension__ __PRETTY_FUNCTION__); }));
    pfs2 = stats_prefix_find("abc:", 4);
    ((void) sizeof (__assert_single_arg (pfs1 == pfs2)), __extension__ ({ if (pfs1 == pfs2) ; else __assert_fail ("pfs1 == pfs2", "testapp.c", 238, __extension__ __PRETTY_FUNCTION__); }));
    pfs2 = stats_prefix_find("abc:d", 5);
    ((void) sizeof (__assert_single_arg (pfs1 == pfs2)), __extension__ ({ if (pfs1 == pfs2) ; else __assert_fail ("pfs1 == pfs2", "testapp.c", 240, __extension__ __PRETTY_FUNCTION__); }));
    pfs2 = stats_prefix_find("xyz123:", 6);
    ((void) sizeof (__assert_single_arg (pfs1 != pfs2)), __extension__ ({ if (pfs1 != pfs2) ; else __assert_fail ("pfs1 != pfs2", "testapp.c", 242, __extension__ __PRETTY_FUNCTION__); }));
    pfs2 = stats_prefix_find("ab:", 3);
    ((void) sizeof (__assert_single_arg (pfs1 != pfs2)), __extension__ ({ if (pfs1 != pfs2) ; else __assert_fail ("pfs1 != pfs2", "testapp.c", 244, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_stats_prefix_record_get(void) {
    ...
    ((void) sizeof (__assert_single_arg (1 == pfs->num_gets)), __extension__ ({ if (1 == pfs->num_gets) ; else __assert_fail ("1 == pfs->num_gets", "testapp.c", 257, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_hits)), __extension__ ({ if (0 == pfs->num_hits) ; else __assert_fail ("0 == pfs->num_hits", "testapp.c", 258, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_get("abc:456", 7, false);
    ((void) sizeof (__assert_single_arg (2 == pfs->num_gets)), __extension__ ({ if (2 == pfs->num_gets) ; else __assert_fail ("2 == pfs->num_gets", "testapp.c", 260, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_hits)), __extension__ ({ if (0 == pfs->num_hits) ; else __assert_fail ("0 == pfs->num_hits", "testapp.c", 261, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_get("abc:456", 7, true);
    ((void) sizeof (__assert_single_arg (3 == pfs->num_gets)), __extension__ ({ if (3 == pfs->num_gets) ; else __assert_fail ("3 == pfs->num_gets", "testapp.c", 263, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (1 == pfs->num_hits)), __extension__ ({ if (1 == pfs->num_hits) ; else __assert_fail ("1 == pfs->num_hits", "testapp.c", 264, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_get("def:", 4, true);
    ((void) sizeof (__assert_single_arg (3 == pfs->num_gets)), __extension__ ({ if (3 == pfs->num_gets) ; else __assert_fail ("3 == pfs->num_gets", "testapp.c", 266, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (1 == pfs->num_hits)), __extension__ ({ if (1 == pfs->num_hits) ; else __assert_fail ("1 == pfs->num_hits", "testapp.c", 267, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_stats_prefix_record_delete(void) {
    ...
    ((void) sizeof (__assert_single_arg (0 == pfs->num_gets)), __extension__ ({ if (0 == pfs->num_gets) ; else __assert_fail ("0 == pfs->num_gets", "testapp.c", 280, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_hits)), __extension__ ({ if (0 == pfs->num_hits) ; else __assert_fail ("0 == pfs->num_hits", "testapp.c", 281, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (1 == pfs->num_deletes)), __extension__ ({ if (1 == pfs->num_deletes) ; else __assert_fail ("1 == pfs->num_deletes", "testapp.c", 282, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_sets)), __extension__ ({ if (0 == pfs->num_sets) ; else __assert_fail ("0 == pfs->num_sets", "testapp.c", 283, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_delete("def:", 4);
    ((void) sizeof (__assert_single_arg (1 == pfs->num_deletes)), __extension__ ({ if (1 == pfs->num_deletes) ; else __assert_fail ("1 == pfs->num_deletes", "testapp.c", 285, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_stats_prefix_record_set(void) {
    ...
    ((void) sizeof (__assert_single_arg (0 == pfs->num_gets)), __extension__ ({ if (0 == pfs->num_gets) ; else __assert_fail ("0 == pfs->num_gets", "testapp.c", 298, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_hits)), __extension__ ({ if (0 == pfs->num_hits) ; else __assert_fail ("0 == pfs->num_hits", "testapp.c", 299, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (0 == pfs->num_deletes)), __extension__ ({ if (0 == pfs->num_deletes) ; else __assert_fail ("0 == pfs->num_deletes", "testapp.c", 300, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (1 == pfs->num_sets)), __extension__ ({ if (1 == pfs->num_sets) ; else __assert_fail ("1 == pfs->num_sets", "testapp.c", 301, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_delete("def:", 4);
    ((void) sizeof (__assert_single_arg (1 == pfs->num_sets)), __extension__ ({ if (1 == pfs->num_sets) ; else __assert_fail ("1 == pfs->num_sets", "testapp.c", 303, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_stats_prefix_dump(void) {
    int hashval = hash("abc", 3) % 256;
    char tmp[500];
    char *buf;
    const char *expected;
    int keynum;
    int length;
    stats_prefix_clear();
    ((void) sizeof (__assert_single_arg (strcmp("END\r\n", (buf = stats_prefix_dump(&length))) == 0)), __extension__ ({ if (strcmp("END\r\n", (buf = stats_prefix_dump(&length))) == 0) ; else __assert_fail ("strcmp(\"END\\r\\n\", (buf = stats_prefix_dump(&length))) == 0", "testapp.c", 317, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (5 == length)), __extension__ ({ if (5 == length) ; else __assert_fail ("5 == length", "testapp.c", 318, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_set("abc:123", 7);
    free(buf);
    expected = "PREFIX abc get 0 hit 0 set 1 del 0\r\nEND\r\n";
    ((void) sizeof (__assert_single_arg (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0)), __extension__ ({ if (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0) ; else __assert_fail ("strcmp(expected, (buf = stats_prefix_dump(&length))) == 0", "testapp.c", 322, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (strlen(expected) == length)), __extension__ ({ if (strlen(expected) == length) ; else __assert_fail ("strlen(expected) == length", "testapp.c", 323, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_get("abc:123", 7, false);
    free(buf);
    expected = "PREFIX abc get 1 hit 0 set 1 del 0\r\nEND\r\n";
    ((void) sizeof (__assert_single_arg (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0)), __extension__ ({ if (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0) ; else __assert_fail ("strcmp(expected, (buf = stats_prefix_dump(&length))) == 0", "testapp.c", 327, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (strlen(expected) == length)), __extension__ ({ if (strlen(expected) == length) ; else __assert_fail ("strlen(expected) == length", "testapp.c", 328, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_get("abc:123", 7, true);
    free(buf);
    expected = "PREFIX abc get 2 hit 1 set 1 del 0\r\nEND\r\n";
    ((void) sizeof (__assert_single_arg (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0)), __extension__ ({ if (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0) ; else __assert_fail ("strcmp(expected, (buf = stats_prefix_dump(&length))) == 0", "testapp.c", 332, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (strlen(expected) == length)), __extension__ ({ if (strlen(expected) == length) ; else __assert_fail ("strlen(expected) == length", "testapp.c", 333, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_delete("abc:123", 7);
    free(buf);
    expected = "PREFIX abc get 2 hit 1 set 1 del 1\r\nEND\r\n";
    ((void) sizeof (__assert_single_arg (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0)), __extension__ ({ if (strcmp(expected, (buf = stats_prefix_dump(&length))) == 0) ; else __assert_fail ("strcmp(expected, (buf = stats_prefix_dump(&length))) == 0", "testapp.c", 337, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (strlen(expected) == length)), __extension__ ({ if (strlen(expected) == length) ; else __assert_fail ("strlen(expected) == length", "testapp.c", 338, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_delete("def:123", 7);
    free(buf);
    buf = stats_prefix_dump(&length);
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")), default: strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")), default: strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"PREFIX abc get 2 hit 1 set 1 del 1\\r\\n\") != NULL", "testapp.c", 345, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")), default: strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")), default: strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"PREFIX def get 0 hit 0 set 0 del 1\\r\\n\") != NULL", "testapp.c", 346, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "END\r\n")), default: strstr (buf, "END\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "END\r\n")), default: strstr (buf, "END\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"END\\r\\n\") != NULL", "testapp.c", 347, __extension__ __PRETTY_FUNCTION__); }));
    free(buf);
    bool found_match = false;
    for (keynum = 0; keynum < 256 * 100; keynum++) {
        snprintf(tmp, sizeof(tmp), "%d:", keynum);
        if (hashval == hash(tmp, strlen(tmp) - 1) % 256) {
            found_match = true;
            break;
        }
    }
    ((void) sizeof (__assert_single_arg (found_match)), __extension__ ({ if (found_match) ; else __assert_fail ("found_match", "testapp.c", 360, __extension__ __PRETTY_FUNCTION__); }));
    stats_prefix_record_set(tmp, strlen(tmp));
    buf = stats_prefix_dump(&length);
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")), default: strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")), default: strstr (buf, "PREFIX abc get 2 hit 1 set 1 del 1\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"PREFIX abc get 2 hit 1 set 1 del 1\\r\\n\") != NULL", "testapp.c", 363, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")), default: strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")), default: strstr (buf, "PREFIX def get 0 hit 0 set 0 del 1\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"PREFIX def get 0 hit 0 set 0 del 1\\r\\n\") != NULL", "testapp.c", 364, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "END\r\n")), default: strstr (buf, "END\r\n")) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, "END\r\n")), default: strstr (buf, "END\r\n")) != ((void *)0)) ; else __assert_fail ("strstr(buf, \"END\\r\\n\") != NULL", "testapp.c", 365, __extension__ __PRETTY_FUNCTION__); }));
    snprintf(tmp, sizeof(tmp), "PREFIX %d get 0 hit 0 set 1 del 0\r\n", keynum);
    ((void) sizeof (__assert_single_arg (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, tmp)), default: strstr (buf, tmp)) != ((void *)0))), __extension__ ({ if (_Generic (0 ? (buf) : (void *) 1, const void *: (const char *) (strstr (buf, tmp)), default: strstr (buf, tmp)) != ((void *)0)) ; else __assert_fail ("strstr(buf, tmp) != NULL", "testapp.c", 367, __extension__ __PRETTY_FUNCTION__); }));
    free(buf);
    stats_prefix_clear();
    return TEST_PASS;
}
static enum test_return test_safe_strtoul(void) {
    uint32_t val;
    ((void) sizeof (__assert_single_arg (safe_strtoul("123", &val))), __extension__ ({ if (safe_strtoul("123", &val)) ; else __assert_fail ("safe_strtoul(\"123\", &val)", "testapp.c", 378, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 379, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoul("+123", &val))), __extension__ ({ if (safe_strtoul("+123", &val)) ; else __assert_fail ("safe_strtoul(\"+123\", &val)", "testapp.c", 380, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 381, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoul("", &val))), __extension__ ({ if (!safe_strtoul("", &val)) ; else __assert_fail ("!safe_strtoul(\"\", &val)", "testapp.c", 382, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoul("123BOGUS", &val))), __extension__ ({ if (!safe_strtoul("123BOGUS", &val)) ; else __assert_fail ("!safe_strtoul(\"123BOGUS\", &val)", "testapp.c", 383, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoul(" issue221", &val))), __extension__ ({ if (!safe_strtoul(" issue221", &val)) ; else __assert_fail ("!safe_strtoul(\" issue221\", &val)", "testapp.c", 384, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoul("4294967295", &val))), __extension__ ({ if (safe_strtoul("4294967295", &val)) ; else __assert_fail ("safe_strtoul(\"4294967295\", &val)", "testapp.c", 390, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 4294967295L)), __extension__ ({ if (val == 4294967295L) ; else __assert_fail ("val == 4294967295L", "testapp.c", 391, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoul("-1", &val))), __extension__ ({ if (!safe_strtoul("-1", &val)) ; else __assert_fail ("!safe_strtoul(\"-1\", &val)", "testapp.c", 395, __extension__ __PRETTY_FUNCTION__); }));
    if (sizeof(unsigned long) > 4) {
        ((void) sizeof (__assert_single_arg (safe_strtoul("18446744073709551615\r\nextrastring-morestring", &val))), __extension__ ({ if (safe_strtoul("18446744073709551615\r\nextrastring-morestring", &val)) ; else __assert_fail ("safe_strtoul(\"18446744073709551615\\r\\nextrastring-morestring\", &val)", "testapp.c", 399, __extension__ __PRETTY_FUNCTION__); }));
    } else {
        ((void) sizeof (__assert_single_arg (safe_strtoul("4294967295\r\nextrastring-morestring", &val))), __extension__ ({ if (safe_strtoul("4294967295\r\nextrastring-morestring", &val)) ; else __assert_fail ("safe_strtoul(\"4294967295\\r\\nextrastring-morestring\", &val)", "testapp.c", 401, __extension__ __PRETTY_FUNCTION__); }));
    }
    return TEST_PASS;
}
static enum test_return test_safe_strtoull(void) {
    uint64_t val;
    ((void) sizeof (__assert_single_arg (safe_strtoull("123", &val))), __extension__ ({ if (safe_strtoull("123", &val)) ; else __assert_fail ("safe_strtoull(\"123\", &val)", "testapp.c", 410, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 411, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoull("+123", &val))), __extension__ ({ if (safe_strtoull("+123", &val)) ; else __assert_fail ("safe_strtoull(\"+123\", &val)", "testapp.c", 412, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 413, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull("", &val))), __extension__ ({ if (!safe_strtoull("", &val)) ; else __assert_fail ("!safe_strtoull(\"\", &val)", "testapp.c", 414, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull("123BOGUS", &val))), __extension__ ({ if (!safe_strtoull("123BOGUS", &val)) ; else __assert_fail ("!safe_strtoull(\"123BOGUS\", &val)", "testapp.c", 415, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull("92837498237498237498029383", &val))), __extension__ ({ if (!safe_strtoull("92837498237498237498029383", &val)) ; else __assert_fail ("!safe_strtoull(\"92837498237498237498029383\", &val)", "testapp.c", 416, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull(" issue221", &val))), __extension__ ({ if (!safe_strtoull(" issue221", &val)) ; else __assert_fail ("!safe_strtoull(\" issue221\", &val)", "testapp.c", 417, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoull("18446744073709551615", &val))), __extension__ ({ if (safe_strtoull("18446744073709551615", &val)) ; else __assert_fail ("safe_strtoull(\"18446744073709551615\", &val)", "testapp.c", 420, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 18446744073709551615ULL)), __extension__ ({ if (val == 18446744073709551615ULL) ; else __assert_fail ("val == 18446744073709551615ULL", "testapp.c", 421, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull("18446744073709551616", &val))), __extension__ ({ if (!safe_strtoull("18446744073709551616", &val)) ; else __assert_fail ("!safe_strtoull(\"18446744073709551616\", &val)", "testapp.c", 422, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoull("-1", &val))), __extension__ ({ if (!safe_strtoull("-1", &val)) ; else __assert_fail ("!safe_strtoull(\"-1\", &val)", "testapp.c", 423, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoull("18446744073709551615\r\nextrastring-morestring", &val))), __extension__ ({ if (safe_strtoull("18446744073709551615\r\nextrastring-morestring", &val)) ; else __assert_fail ("safe_strtoull(\"18446744073709551615\\r\\nextrastring-morestring\", &val)", "testapp.c", 426, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_safe_strtoll(void) {
    int64_t val;
    ((void) sizeof (__assert_single_arg (safe_strtoll("123", &val))), __extension__ ({ if (safe_strtoll("123", &val)) ; else __assert_fail ("safe_strtoll(\"123\", &val)", "testapp.c", 432, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 433, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoll("+123", &val))), __extension__ ({ if (safe_strtoll("+123", &val)) ; else __assert_fail ("safe_strtoll(\"+123\", &val)", "testapp.c", 434, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 435, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoll("-123", &val))), __extension__ ({ if (safe_strtoll("-123", &val)) ; else __assert_fail ("safe_strtoll(\"-123\", &val)", "testapp.c", 436, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == -123)), __extension__ ({ if (val == -123) ; else __assert_fail ("val == -123", "testapp.c", 437, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll("", &val))), __extension__ ({ if (!safe_strtoll("", &val)) ; else __assert_fail ("!safe_strtoll(\"\", &val)", "testapp.c", 438, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll("123BOGUS", &val))), __extension__ ({ if (!safe_strtoll("123BOGUS", &val)) ; else __assert_fail ("!safe_strtoll(\"123BOGUS\", &val)", "testapp.c", 439, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll("92837498237498237498029383", &val))), __extension__ ({ if (!safe_strtoll("92837498237498237498029383", &val)) ; else __assert_fail ("!safe_strtoll(\"92837498237498237498029383\", &val)", "testapp.c", 440, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll(" issue221", &val))), __extension__ ({ if (!safe_strtoll(" issue221", &val)) ; else __assert_fail ("!safe_strtoll(\" issue221\", &val)", "testapp.c", 441, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll("18446744073709551615", &val))), __extension__ ({ if (!safe_strtoll("18446744073709551615", &val)) ; else __assert_fail ("!safe_strtoll(\"18446744073709551615\", &val)", "testapp.c", 444, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoll("9223372036854775807", &val))), __extension__ ({ if (safe_strtoll("9223372036854775807", &val)) ; else __assert_fail ("safe_strtoll(\"9223372036854775807\", &val)", "testapp.c", 445, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 9223372036854775807LL)), __extension__ ({ if (val == 9223372036854775807LL) ; else __assert_fail ("val == 9223372036854775807LL", "testapp.c", 446, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtoll("-9223372036854775809", &val))), __extension__ ({ if (!safe_strtoll("-9223372036854775809", &val)) ; else __assert_fail ("!safe_strtoll(\"-9223372036854775809\", &val)", "testapp.c", 451, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtoll(" 123 foo", &val))), __extension__ ({ if (safe_strtoll(" 123 foo", &val)) ; else __assert_fail ("safe_strtoll(\" 123 foo\", &val)", "testapp.c", 454, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 455, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_safe_strtol(void) {
    int32_t val;
    ((void) sizeof (__assert_single_arg (safe_strtol("123", &val))), __extension__ ({ if (safe_strtol("123", &val)) ; else __assert_fail ("safe_strtol(\"123\", &val)", "testapp.c", 461, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 462, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtol("+123", &val))), __extension__ ({ if (safe_strtol("+123", &val)) ; else __assert_fail ("safe_strtol(\"+123\", &val)", "testapp.c", 463, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 464, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtol("-123", &val))), __extension__ ({ if (safe_strtol("-123", &val)) ; else __assert_fail ("safe_strtol(\"-123\", &val)", "testapp.c", 465, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == -123)), __extension__ ({ if (val == -123) ; else __assert_fail ("val == -123", "testapp.c", 466, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtol("", &val))), __extension__ ({ if (!safe_strtol("", &val)) ; else __assert_fail ("!safe_strtol(\"\", &val)", "testapp.c", 467, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtol("123BOGUS", &val))), __extension__ ({ if (!safe_strtol("123BOGUS", &val)) ; else __assert_fail ("!safe_strtol(\"123BOGUS\", &val)", "testapp.c", 468, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtol("92837498237498237498029383", &val))), __extension__ ({ if (!safe_strtol("92837498237498237498029383", &val)) ; else __assert_fail ("!safe_strtol(\"92837498237498237498029383\", &val)", "testapp.c", 469, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (!safe_strtol(" issue221", &val))), __extension__ ({ if (!safe_strtol(" issue221", &val)) ; else __assert_fail ("!safe_strtol(\" issue221\", &val)", "testapp.c", 470, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtol("2147483647", &val))), __extension__ ({ if (safe_strtol("2147483647", &val)) ; else __assert_fail ("safe_strtol(\"2147483647\", &val)", "testapp.c", 476, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 2147483647L)), __extension__ ({ if (val == 2147483647L) ; else __assert_fail ("val == 2147483647L", "testapp.c", 477, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (safe_strtol(" 123 foo", &val))), __extension__ ({ if (safe_strtol(" 123 foo", &val)) ; else __assert_fail ("safe_strtol(\" 123 foo\", &val)", "testapp.c", 483, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (val == 123)), __extension__ ({ if (val == 123) ; else __assert_fail ("val == 123", "testapp.c", 484, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static pid_t start_server(in_port_t *port_out, bool daemon, int timeout) {
    ...
    remove(pid_file);
    pid_t pid = fork();
    ((void) sizeof (__assert_single_arg (pid != -1)), __extension__ ({ if (pid != -1) ; else __assert_fail ("pid != -1", "testapp.c", 519, __extension__ __PRETTY_FUNCTION__); }));
    if (pid == 0) {
        char *argv[24];
        int arg = 0;
        char tmo[24];
        ...
        argv[arg++] = ((void *)0);
        ((void) sizeof (__assert_single_arg (execv(argv[0], argv) != -1)), __extension__ ({ if (execv(argv[0], argv) != -1) ; else __assert_fail ("execv(argv[0], argv) != -1", "testapp.c", 570, __extension__ __PRETTY_FUNCTION__); }));
    }
    useconds_t wait_timeout = 1000000 * 10;
    useconds_t wait = 1000;
    while (access(filename, 0) == -1 && wait_timeout > 0) {
        usleep(wait);
        wait_timeout -= (wait > wait_timeout ? wait_timeout : wait);
    }
    if (access(filename, 0) == -1) {
        fprintf(stderr, "Failed to start the memcached server.\n");
        ((void) sizeof (__assert_single_arg (false)), __extension__ ({ if (false) ; else __assert_fail ("false", "testapp.c", 583, __extension__ __PRETTY_FUNCTION__); }));
    }
    FILE *fp = fopen(filename, "r");
    if (fp == ((void *)0)) {
        fprintf(stderr, "Failed to open the file containing port numbers: %s\n",
                strerror((*__errno_location ())));
        ((void) sizeof (__assert_single_arg (false)), __extension__ ({ if (false) ; else __assert_fail ("false", "testapp.c", 590, __extension__ __PRETTY_FUNCTION__); }));
    }
    *port_out = (in_port_t)-1;
    ...
    while ((fgets(buffer, sizeof(buffer), fp)) != ((void *)0)) {
        if (strncmp(buffer, "TCP INET: ", 10) == 0) {
            int32_t val;
            ((void) sizeof (__assert_single_arg (safe_strtol(buffer + 10, &val))), __extension__ ({ if (safe_strtol(buffer + 10, &val)) ; else __assert_fail ("safe_strtol(buffer + 10, &val)", "testapp.c", 598, __extension__ __PRETTY_FUNCTION__); }));
            *port_out = (in_port_t)val;
        }
    }
    fclose(fp);
    ((void) sizeof (__assert_single_arg (remove(filename) == 0)), __extension__ ({ if (remove(filename) == 0) ; else __assert_fail ("remove(filename) == 0", "testapp.c", 603, __extension__ __PRETTY_FUNCTION__); }));
    if (daemon) {
        while (access(pid_file, 0) == -1) {
            usleep(10);
        }
        fp = fopen(pid_file, "r");
        if (fp == ((void *)0)) {
            fprintf(stderr, "Failed to open pid file: %s\n",
                    strerror((*__errno_location ())));
            ((void) sizeof (__assert_single_arg (false)), __extension__ ({ if (false) ; else __assert_fail ("false", "testapp.c", 618, __extension__ __PRETTY_FUNCTION__); }));
        }
        ...
        fclose(fp);
        int32_t val;
        ((void) sizeof (__assert_single_arg (safe_strtol(buffer, &val))), __extension__ ({ if (safe_strtol(buffer, &val)) ; else __assert_fail ("safe_strtol(buffer, &val)", "testapp.c", 628, __extension__ __PRETTY_FUNCTION__); }));
        pid = (pid_t)val;
    }
    return pid;
}
static enum test_return test_issue_44(void) {
    ...
    ((void) sizeof (__assert_single_arg (kill(pid, 1) == 0)), __extension__ ({ if (kill(pid, 1) == 0) ; else __assert_fail ("kill(pid, SIGHUP) == 0", "testapp.c", 638, __extension__ __PRETTY_FUNCTION__); }));
    sleep(1);
    ((void) sizeof (__assert_single_arg (kill(pid, 15) == 0)), __extension__ ({ if (kill(pid, 15) == 0) ; else __assert_fail ("kill(pid, SIGTERM) == 0", "testapp.c", 640, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static struct addrinfo *lookuphost(const char *hostname, in_port_t port)
{
    ...
    char service[32];
    int error;
    (void)snprintf(service, 32, "%d", port);
       ...
       if ((sock = socket(ai->ai_family, ai->ai_socktype,
          ...
          if (connect(sock, ai->ai_addr, ai->ai_addrlen) == -1) {
             ...
             sock = -1;
              ...
              if (flags < 0 || fcntl(sock, 4, flags | 04000) < 0) {
...
static enum test_return test_vperror(void) {
    int rv = 0;
    int oldstderr = dup(2);
    ((void) sizeof (__assert_single_arg (oldstderr >= 0)), __extension__ ({ if (oldstderr >= 0) ; else __assert_fail ("oldstderr >= 0", "testapp.c", 743, __extension__ __PRETTY_FUNCTION__); }));
    char tmpl[sizeof("/tmp/test_file.XXXXXXX")+1];
    strncpy(tmpl, "/tmp/test_file.XXXXXXX", sizeof("/tmp/test_file.XXXXXXX")+1);
    int newfile = mkstemp(tmpl);
    ((void) sizeof (__assert_single_arg (newfile > 0)), __extension__ ({ if (newfile > 0) ; else __assert_fail ("newfile > 0", "testapp.c", 748, __extension__ __PRETTY_FUNCTION__); }));
    rv = dup2(newfile, 2);
    ((void) sizeof (__assert_single_arg (rv == 2)), __extension__ ({ if (rv == 2) ; else __assert_fail ("rv == STDERR_FILENO", "testapp.c", 750, __extension__ __PRETTY_FUNCTION__); }));
    rv = close(newfile);
    ((void) sizeof (__assert_single_arg (rv == 0)), __extension__ ({ if (rv == 0) ; else __assert_fail ("rv == 0", "testapp.c", 752, __extension__ __PRETTY_FUNCTION__); }));
    (*__errno_location ()) = 5;
    vperror("Old McDonald had a farm.  %s", "EI EIO");
    rv = dup2(oldstderr, 2);
    ((void) sizeof (__assert_single_arg (rv == 2)), __extension__ ({ if (rv == 2) ; else __assert_fail ("rv == STDERR_FILENO", "testapp.c", 759, __extension__ __PRETTY_FUNCTION__); }));
    char buf[80] = { 0 };
    FILE *efile = fopen(tmpl, "r");
    ((void) sizeof (__assert_single_arg (efile)), __extension__ ({ if (efile) ; else __assert_fail ("efile", "testapp.c", 765, __extension__ __PRETTY_FUNCTION__); }));
    char *prv = fgets(buf, sizeof(buf), efile);
    ((void) sizeof (__assert_single_arg (prv)), __extension__ ({ if (prv) ; else __assert_fail ("prv", "testapp.c", 767, __extension__ __PRETTY_FUNCTION__); }));
    fclose(efile);
    unlink(tmpl);
    char expected[80] = { 0 };
...
static void read_ascii_response(char *buffer, size_t size) {
    ...
    do {
        ...
        if (nr == -1) {
            ...
            ((void) sizeof (__assert_single_arg (nr == 1)), __extension__ ({ if (nr == 1) ; else __assert_fail ("nr == 1", "testapp.c", 820, __extension__ __PRETTY_FUNCTION__); }));
            if (buffer[offset] == '\n') {
                need_more = false;
                buffer[offset + 1] = '\0';
            }
            offset += nr;
            ((void) sizeof (__assert_single_arg (offset + 1 < size)), __extension__ ({ if (offset + 1 < size) ; else __assert_fail ("offset + 1 < size", "testapp.c", 826, __extension__ __PRETTY_FUNCTION__); }));
        }
    } while (need_more);
}
static enum test_return test_issue_92(void) {
    ...
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 836, __extension__ __PRETTY_FUNCTION__); }));
    send_ascii_command("stats cachedump 1 0 0\r\n");
    read_ascii_response(buffer, sizeof(buffer));
    ((void) sizeof (__assert_single_arg (strncmp(buffer, "END", strlen("END")) == 0)), __extension__ ({ if (strncmp(buffer, "END", strlen("END")) == 0) ; else __assert_fail ("strncmp(buffer, \"END\", strlen(\"END\")) == 0", "testapp.c", 841, __extension__ __PRETTY_FUNCTION__); }));
    send_ascii_command("stats cachedump 200 0 0\r\n");
    read_ascii_response(buffer, sizeof(buffer));
    ((void) sizeof (__assert_single_arg (strncmp(buffer, "CLIENT_ERROR", strlen("CLIENT_ERROR")) == 0)), __extension__ ({ if (strncmp(buffer, "CLIENT_ERROR", strlen("CLIENT_ERROR")) == 0) ; else __assert_fail ("strncmp(buffer, \"CLIENT_ERROR\", strlen(\"CLIENT_ERROR\")) == 0", "testapp.c", 845, __extension__ __PRETTY_FUNCTION__); }));
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 849, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_crc32c(void) {
    ...
    ((void) sizeof (__assert_single_arg (crc_hw == 0x9c44184b)), __extension__ ({ if (crc_hw == 0x9c44184b) ; else __assert_fail ("crc_hw == 0x9c44184b", "testapp.c", 863, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (crc_sw == 0x9c44184b)), __extension__ ({ if (crc_sw == 0x9c44184b) ; else __assert_fail ("crc_sw == 0x9c44184b", "testapp.c", 864, __extension__ __PRETTY_FUNCTION__); }));
    crc_hw = crc32c(crc_hw, buffer, 256);
    crc_sw = crc32c_sw(crc_sw, buffer, 256);
    ((void) sizeof (__assert_single_arg (crc_hw == 0xae10ee5a)), __extension__ ({ if (crc_hw == 0xae10ee5a) ; else __assert_fail ("crc_hw == 0xae10ee5a", "testapp.c", 869, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (crc_sw == 0xae10ee5a)), __extension__ ({ if (crc_sw == 0xae10ee5a) ; else __assert_fail ("crc_sw == 0xae10ee5a", "testapp.c", 870, __extension__ __PRETTY_FUNCTION__); }));
    crc_hw = crc32c(crc_hw, buffer + 1, 256 - 2);
    crc_sw = crc32c_sw(crc_sw, buffer + 1, 256 - 2);
    ((void) sizeof (__assert_single_arg (crc_hw == 0xed37b906)), __extension__ ({ if (crc_hw == 0xed37b906) ; else __assert_fail ("crc_hw == 0xed37b906", "testapp.c", 875, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (crc_sw == 0xed37b906)), __extension__ ({ if (crc_sw == 0xed37b906) ; else __assert_fail ("crc_sw == 0xed37b906", "testapp.c", 876, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return test_issue_102(void) {
    ...
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 888, __extension__ __PRETTY_FUNCTION__); }));
    send_ascii_command(buffer);
    ((void) sizeof (__assert_single_arg (con->read(con, buffer, sizeof(buffer)) == 0)), __extension__ ({ if (con->read(con, buffer, sizeof(buffer)) == 0) ; else __assert_fail ("con->read(con, buffer, sizeof(buffer)) == 0", "testapp.c", 892, __extension__ __PRETTY_FUNCTION__); }));
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 896, __extension__ __PRETTY_FUNCTION__); }));
    ...
    ((void) sizeof (__assert_single_arg (strncmp(rsp, "END", strlen("END")) == 0)), __extension__ ({ if (strncmp(rsp, "END", strlen("END")) == 0) ; else __assert_fail ("strncmp(rsp, \"END\", strlen(\"END\")) == 0", "testapp.c", 911, __extension__ __PRETTY_FUNCTION__); }));
    buffer[3]= ' ';
    send_ascii_command(buffer);
    usleep(250);
    send_ascii_command("\r\n");
    read_ascii_response(rsp, sizeof(rsp));
    ((void) sizeof (__assert_single_arg (strncmp(rsp, "END", strlen("END")) == 0)), __extension__ ({ if (strncmp(rsp, "END", strlen("END")) == 0) ; else __assert_fail ("strncmp(rsp, \"END\", strlen(\"END\")) == 0", "testapp.c", 917, __extension__ __PRETTY_FUNCTION__); }));
    memset(buffer, ' ', sizeof(buffer));
    int len = snprintf(buffer + 101, sizeof(buffer) - 101, "gets foo");
    buffer[101 + len] = ' ';
    buffer[sizeof(buffer) - 1] = '\0';
    send_ascii_command(buffer);
    ((void) sizeof (__assert_single_arg (con->read(con, buffer, sizeof(buffer)) == 0)), __extension__ ({ if (con->read(con, buffer, sizeof(buffer)) == 0) ; else __assert_fail ("con->read(con, buffer, sizeof(buffer)) == 0", "testapp.c", 925, __extension__ __PRETTY_FUNCTION__); }));
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 929, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return start_memcached_server(void) {
    ...
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 938, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
static enum test_return stop_memcached_server(void) {
    close_conn();
    if (server_pid != -1) {
        ((void) sizeof (__assert_single_arg (kill(server_pid, 15) == 0)), __extension__ ({ if (kill(server_pid, 15) == 0) ; else __assert_fail ("kill(server_pid, SIGTERM) == 0", "testapp.c", 945, __extension__ __PRETTY_FUNCTION__); }));
    }
    return TEST_PASS;
}
static enum test_return shutdown_memcached_server(void) {
    ...
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 956, __extension__ __PRETTY_FUNCTION__); }));
    send_ascii_command("shutdown\r\n");
    ((void) sizeof (__assert_single_arg (con->read(con, buffer, sizeof(buffer)) == 0)), __extension__ ({ if (con->read(con, buffer, sizeof(buffer)) == 0) ; else __assert_fail ("con->read(con, buffer, sizeof(buffer)) == 0", "testapp.c", 960, __extension__ __PRETTY_FUNCTION__); }));
    close_conn();
...
static bool safe_recv(void *buf, size_t len) {
    ...
    do {
        ...
        if (nr == -1) {
            ...
            ((void) sizeof (__assert_single_arg (nr != 0)), __extension__ ({ if (nr != 0) ; else __assert_fail ("nr != 0", "testapp.c", 1029, __extension__ __PRETTY_FUNCTION__); }));
            offset += nr;
        }
    } while (offset < len);
    return true;
...
static bool safe_recv_packet(void *buf, size_t size) {
    ...
    ((void) sizeof (__assert_single_arg (size > sizeof(*response))), __extension__ ({ if (size > sizeof(*response)) ; else __assert_fail ("size > sizeof(*response)", "testapp.c", 1039, __extension__ __PRETTY_FUNCTION__); }));
    if (!safe_recv(response, sizeof(*response))) {
        return false;
    }
    response->message.header.response.keylen = __bswap_16 (response->message.header.response.keylen);
    response->message.header.response.status = __bswap_16 (response->message.header.response.status);
    response->message.header.response.bodylen = __bswap_32 (response->message.header.response.bodylen);
...
static off_t storage_command(char*buf,
    ...
    ((void) sizeof (__assert_single_arg (bufsz > sizeof(*request) + keylen + dtalen)), __extension__ ({ if (bufsz > sizeof(*request) + keylen + dtalen) ; else __assert_fail ("bufsz > sizeof(*request) + keylen + dtalen", "testapp.c", 1085, __extension__ __PRETTY_FUNCTION__); }));
    memset(request, 0, sizeof(*request));
    request->message.header.request.magic = PROTOCOL_BINARY_REQ;
    request->message.header.request.opcode = cmd;
    request->message.header.request.keylen = __bswap_16 (keylen);
    request->message.header.request.extlen = 8;
    request->message.header.request.bodylen = __bswap_32 (keylen + 8 + dtalen);
...
static off_t ext_command(char* buf,
    ...
    ((void) sizeof (__assert_single_arg (bufsz > sizeof(*request) + extlen + keylen + dtalen)), __extension__ ({ if (bufsz > sizeof(*request) + extlen + keylen + dtalen) ; else __assert_fail ("bufsz > sizeof(*request) + extlen + keylen + dtalen", "testapp.c", 1117, __extension__ __PRETTY_FUNCTION__); }));
    memset(request, 0, sizeof(*request));
    request->message.header.request.magic = PROTOCOL_BINARY_REQ;
    request->message.header.request.opcode = cmd;
    request->message.header.request.extlen = extlen;
    request->message.header.request.keylen = __bswap_16 (keylen);
    request->message.header.request.bodylen = __bswap_32 (extlen + keylen + dtalen);
    request->message.header.request.opaque = 0xdeadbeef;
...
static off_t flush_command(char* buf, size_t bufsz, uint8_t cmd, uint32_t exptime, bool use_extra) {
    ...
    ((void) sizeof (__assert_single_arg (bufsz > sizeof(*request))), __extension__ ({ if (bufsz > sizeof(*request)) ; else __assert_fail ("bufsz > sizeof(*request)", "testapp.c", 1157, __extension__ __PRETTY_FUNCTION__); }));
    memset(request, 0, sizeof(*request));
    request->message.header.request.magic = PROTOCOL_BINARY_REQ;
    request->message.header.request.opcode = cmd;
    ...
    if (use_extra) {
        ...
        request->message.body.expiration = __bswap_32 (exptime);
        request->message.header.request.bodylen = __bswap_32 (4);
        size += 4;
    }
    request->message.header.request.opaque = 0xdeadbeef;
    return size;
...
static off_t touch_command(char* buf,
    ...
    ((void) sizeof (__assert_single_arg (bufsz > sizeof(*request))), __extension__ ({ if (bufsz > sizeof(*request)) ; else __assert_fail ("bufsz > sizeof(*request)", "testapp.c", 1184, __extension__ __PRETTY_FUNCTION__); }));
    memset(request, 0, sizeof(*request));
    request->message.header.request.magic = PROTOCOL_BINARY_REQ;
    request->message.header.request.opcode = cmd;
    request->message.header.request.keylen = __bswap_16 (keylen);
    request->message.header.request.extlen = 4;
    request->message.body.expiration = __bswap_32 (exptime);
    request->message.header.request.bodylen = __bswap_32 (keylen + 4);
    request->message.header.request.opaque = 0xdeadbeef;
...
static off_t arithmetic_command(char* buf,
    ...
    ((void) sizeof (__assert_single_arg (bufsz > sizeof(*request) + keylen)), __extension__ ({ if (bufsz > sizeof(*request) + keylen) ; else __assert_fail ("bufsz > sizeof(*request) + keylen", "testapp.c", 1212, __extension__ __PRETTY_FUNCTION__); }));
    memset(request, 0, sizeof(*request));
    request->message.header.request.magic = PROTOCOL_BINARY_REQ;
    request->message.header.request.opcode = cmd;
    request->message.header.request.keylen = __bswap_16 (keylen);
    request->message.header.request.extlen = 20;
    request->message.header.request.bodylen = __bswap_32 (keylen + 20);
    request->message.header.request.opaque = 0xdeadbeef;
    request->message.body.delta = htonll(delta);
    request->message.body.initial = htonll(initial);
    request->message.body.expiration = __bswap_32 (exp);
...
{
    ((void) sizeof (__assert_single_arg (response->message.header.response.magic == PROTOCOL_BINARY_RES)), __extension__ ({ if (response->message.header.response.magic == PROTOCOL_BINARY_RES) ; else __assert_fail ("response->message.header.response.magic == PROTOCOL_BINARY_RES", "testapp.c", 1234, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (response->message.header.response.opcode == cmd)), __extension__ ({ if (response->message.header.response.opcode == cmd) ; else __assert_fail ("response->message.header.response.opcode == cmd", "testapp.c", 1235, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (response->message.header.response.datatype == PROTOCOL_BINARY_RAW_BYTES)), __extension__ ({ if (response->message.header.response.datatype == PROTOCOL_BINARY_RAW_BYTES) ; else __assert_fail ("response->message.header.response.datatype == PROTOCOL_BINARY_RAW_BYTES", "testapp.c", 1236, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (response->message.header.response.status == status)), __extension__ ({ if (response->message.header.response.status == status) ; else __assert_fail ("response->message.header.response.status == status", "testapp.c", 1237, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (response->message.header.response.opaque == 0xdeadbeef)), __extension__ ({ if (response->message.header.response.opaque == 0xdeadbeef) ; else __assert_fail ("response->message.header.response.opaque == 0xdeadbeef", "testapp.c", 1238, __extension__ __PRETTY_FUNCTION__); }));
    if (status == PROTOCOL_BINARY_RESPONSE_SUCCESS) {
        ...
        case PROTOCOL_BINARY_CMD_SETQ:
            ((void) sizeof (__assert_single_arg ("Quiet command shouldn't return on success" == ((void *)0))), __extension__ ({ if ("Quiet command shouldn't return on success" == ((void *)0)) ; else __assert_fail ("\"Quiet command shouldn't return on success\" == NULL", "testapp.c", 1252, __extension__ __PRETTY_FUNCTION__); }));
        default:
            break;
        }
        switch (cmd) {
        ...
        case PROTOCOL_BINARY_CMD_PREPEND:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1263, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1264, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.bodylen == 0)), __extension__ ({ if (response->message.header.response.bodylen == 0) ; else __assert_fail ("response->message.header.response.bodylen == 0", "testapp.c", 1265, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas != 0)), __extension__ ({ if (response->message.header.response.cas != 0) ; else __assert_fail ("response->message.header.response.cas != 0", "testapp.c", 1266, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_FLUSH:
        case PROTOCOL_BINARY_CMD_NOOP:
        case PROTOCOL_BINARY_CMD_QUIT:
        case PROTOCOL_BINARY_CMD_DELETE:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1272, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1273, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.bodylen == 0)), __extension__ ({ if (response->message.header.response.bodylen == 0) ; else __assert_fail ("response->message.header.response.bodylen == 0", "testapp.c", 1274, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas == 0)), __extension__ ({ if (response->message.header.response.cas == 0) ; else __assert_fail ("response->message.header.response.cas == 0", "testapp.c", 1275, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_DECREMENT:
        case PROTOCOL_BINARY_CMD_INCREMENT:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1280, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1281, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.bodylen == 8)), __extension__ ({ if (response->message.header.response.bodylen == 8) ; else __assert_fail ("response->message.header.response.bodylen == 8", "testapp.c", 1282, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas != 0)), __extension__ ({ if (response->message.header.response.cas != 0) ; else __assert_fail ("response->message.header.response.cas != 0", "testapp.c", 1283, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_STAT:
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1287, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas == 0)), __extension__ ({ if (response->message.header.response.cas == 0) ; else __assert_fail ("response->message.header.response.cas == 0", "testapp.c", 1289, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_VERSION:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1293, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1294, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.bodylen != 0)), __extension__ ({ if (response->message.header.response.bodylen != 0) ; else __assert_fail ("response->message.header.response.bodylen != 0", "testapp.c", 1295, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas == 0)), __extension__ ({ if (response->message.header.response.cas == 0) ; else __assert_fail ("response->message.header.response.cas == 0", "testapp.c", 1296, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_GET:
        case PROTOCOL_BINARY_CMD_GETQ:
        case PROTOCOL_BINARY_CMD_GAT:
        case PROTOCOL_BINARY_CMD_GATQ:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1303, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 4)), __extension__ ({ if (response->message.header.response.extlen == 4) ; else __assert_fail ("response->message.header.response.extlen == 4", "testapp.c", 1304, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas != 0)), __extension__ ({ if (response->message.header.response.cas != 0) ; else __assert_fail ("response->message.header.response.cas != 0", "testapp.c", 1305, __extension__ __PRETTY_FUNCTION__); }));
            break;
        case PROTOCOL_BINARY_CMD_GETK:
        case PROTOCOL_BINARY_CMD_GETKQ:
        case PROTOCOL_BINARY_CMD_GATK:
        case PROTOCOL_BINARY_CMD_GATKQ:
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen != 0)), __extension__ ({ if (response->message.header.response.keylen != 0) ; else __assert_fail ("response->message.header.response.keylen != 0", "testapp.c", 1312, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 4)), __extension__ ({ if (response->message.header.response.extlen == 4) ; else __assert_fail ("response->message.header.response.extlen == 4", "testapp.c", 1313, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof (__assert_single_arg (response->message.header.response.cas != 0)), __extension__ ({ if (response->message.header.response.cas != 0) ; else __assert_fail ("response->message.header.response.cas != 0", "testapp.c", 1314, __extension__ __PRETTY_FUNCTION__); }));
            break;
        default:
            break;
        }
    } else {
        ((void) sizeof (__assert_single_arg (response->message.header.response.cas == 0)), __extension__ ({ if (response->message.header.response.cas == 0) ; else __assert_fail ("response->message.header.response.cas == 0", "testapp.c", 1322, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof (__assert_single_arg (response->message.header.response.extlen == 0)), __extension__ ({ if (response->message.header.response.extlen == 0) ; else __assert_fail ("response->message.header.response.extlen == 0", "testapp.c", 1323, __extension__ __PRETTY_FUNCTION__); }));
        if (cmd != PROTOCOL_BINARY_CMD_GETK &&
            cmd != PROTOCOL_BINARY_CMD_GATK) {
            ((void) sizeof (__assert_single_arg (response->message.header.response.keylen == 0)), __extension__ ({ if (response->message.header.response.keylen == 0) ; else __assert_fail ("response->message.header.response.keylen == 0", "testapp.c", 1326, __extension__ __PRETTY_FUNCTION__); }));
        }
    }
}
...
static enum test_return test_binary_quit_impl(uint8_t cmd) {
    ...
    ((void) sizeof (__assert_single_arg (con->read(con, buffer.bytes, sizeof(buffer.bytes)) == 0)), __extension__ ({ if (con->read(con, buffer.bytes, sizeof(buffer.bytes)) == 0) ; else __assert_fail ("con->read(con, buffer.bytes, sizeof(buffer.bytes)) == 0", "testapp.c", 1367, __extension__ __PRETTY_FUNCTION__); }));
    close_conn();
    con = connect_server("127.0.0.1", port, false, enable_ssl);
    ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 1370, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
...
static enum test_return test_binary_set_impl(const char *key, uint8_t cmd) {
    ...
    if (cmd == PROTOCOL_BINARY_CMD_SET) {
        ...
        validate_response_header(&receive.response, cmd,
                                 PROTOCOL_BINARY_RESPONSE_SUCCESS);
        ((void) sizeof (__assert_single_arg (receive.response.message.header.response.cas != send.request.message.header.request.cas)), __extension__ ({ if (receive.response.message.header.response.cas != send.request.message.header.request.cas) ; else __assert_fail ("receive.response.message.header.response.cas != send.request.message.header.request.cas", "testapp.c", 1415, __extension__ __PRETTY_FUNCTION__); }));
    } else {
        return test_binary_noop();
    }
    return TEST_PASS;
...
static enum test_return test_binary_get_impl(const char *key, uint8_t cmd) {
    ...
    uint32_t expiration = __bswap_32 (3600);
    size_t extlen = 0;
    ...
    for (ii = 0; ii < 10; ++ii) {
        ...
        if (cmd == PROTOCOL_BINARY_CMD_INCREMENT) {
            ...
            validate_response_header(&receive.response_header, cmd,
                                     PROTOCOL_BINARY_RESPONSE_SUCCESS);
            ((void) sizeof (__assert_single_arg (ntohll(receive.response.message.body.value) == ii)), __extension__ ({ if (ntohll(receive.response.message.body.value) == ii) ; else __assert_fail ("ntohll(receive.response.message.body.value) == ii", "testapp.c", 1720, __extension__ __PRETTY_FUNCTION__); }));
        }
    }
...
static enum test_return test_binary_decr_impl(const char* key, uint8_t cmd) {
    ...
    for (ii = 9; ii >= 0; --ii) {
        ...
        if (cmd == PROTOCOL_BINARY_CMD_DECREMENT) {
            ...
            validate_response_header(&receive.response_header, cmd,
                                     PROTOCOL_BINARY_RESPONSE_SUCCESS);
            ((void) sizeof (__assert_single_arg (ntohll(receive.response.message.body.value) == ii)), __extension__ ({ if (ntohll(receive.response.message.body.value) == ii) ; else __assert_fail ("ntohll(receive.response.message.body.value) == ii", "testapp.c", 1757, __extension__ __PRETTY_FUNCTION__); }));
        }
    }
    safe_send(send.bytes, len, false);
    if (cmd == PROTOCOL_BINARY_CMD_DECREMENT) {
        ...
        validate_response_header(&receive.response_header, cmd,
                                 PROTOCOL_BINARY_RESPONSE_SUCCESS);
        ((void) sizeof (__assert_single_arg (ntohll(receive.response.message.body.value) == 0)), __extension__ ({ if (ntohll(receive.response.message.body.value) == 0) ; else __assert_fail ("ntohll(receive.response.message.body.value) == 0", "testapp.c", 1767, __extension__ __PRETTY_FUNCTION__); }));
    } else {
        test_binary_noop();
    }
    return TEST_PASS;
...
static enum test_return test_binary_concat_impl(const char *key, uint8_t cmd) {
    ...
    validate_response_header(&receive.response, PROTOCOL_BINARY_CMD_GETK,
                             PROTOCOL_BINARY_RESPONSE_SUCCESS);
    ((void) sizeof (__assert_single_arg (receive.response.message.header.response.keylen == strlen(key))), __extension__ ({ if (receive.response.message.header.response.keylen == strlen(key)) ; else __assert_fail ("receive.response.message.header.response.keylen == strlen(key)", "testapp.c", 1930, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (__assert_single_arg (receive.response.message.header.response.bodylen == (strlen(key) + 2*strlen(value) + 4))), __extension__ ({ if (receive.response.message.header.response.bodylen == (strlen(key) + 2*strlen(value) + 4)) ; else __assert_fail ("receive.response.message.header.response.bodylen == (strlen(key) + 2*strlen(value) + 4)", "testapp.c", 1931, __extension__ __PRETTY_FUNCTION__); }));
    char *ptr = receive.bytes;
    ptr += sizeof(receive.response);
    ptr += 4;
    ((void) sizeof (__assert_single_arg (memcmp(ptr, key, strlen(key)) == 0)), __extension__ ({ if (memcmp(ptr, key, strlen(key)) == 0) ; else __assert_fail ("memcmp(ptr, key, strlen(key)) == 0", "testapp.c", 1937, __extension__ __PRETTY_FUNCTION__); }));
    ptr += strlen(key);
    ((void) sizeof (__assert_single_arg (memcmp(ptr, value, strlen(value)) == 0)), __extension__ ({ if (memcmp(ptr, value, strlen(value)) == 0) ; else __assert_fail ("memcmp(ptr, value, strlen(value)) == 0", "testapp.c", 1939, __extension__ __PRETTY_FUNCTION__); }));
    ptr += strlen(value);
    ((void) sizeof (__assert_single_arg (memcmp(ptr, value, strlen(value)) == 0)), __extension__ ({ if (memcmp(ptr, value, strlen(value)) == 0) ; else __assert_fail ("memcmp(ptr, value, strlen(value)) == 0", "testapp.c", 1941, __extension__ __PRETTY_FUNCTION__); }));
    return TEST_PASS;
}
...
static enum test_return test_issue_101(void) {
    ...
    int ii = 0;
    pid_t child = 0;
    if (getenv("SKIP_TEST_101") != ((void *)0)) {
        return TEST_SKIP;
    }
    ...
    for (ii = 0; ii < max; ++ii) {
        ...
        ((void) sizeof (__assert_single_arg (conns[ii])), __extension__ ({ if (conns[ii]) ; else __assert_fail ("conns[ii]", "testapp.c", 2188, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof (__assert_single_arg (conns[ii]->sock > 0)), __extension__ ({ if (conns[ii]->sock > 0) ; else __assert_fail ("conns[ii]->sock > 0", "testapp.c", 2189, __extension__ __PRETTY_FUNCTION__); }));
    }
    for (ii = 0; ii < max; ++ii) {
        bool more = true;
        do {
    ...
    if (child == (pid_t)-1) {
        ...
        int stat;
        pid_t c;
        while ((c = waitpid(child, &stat, 0)) == (pid_t)-1 && (*__errno_location ()) == 4);
        ((void) sizeof (__assert_single_arg (c == child)), __extension__ ({ if (c == child) ; else __assert_fail ("c == child", "testapp.c", 2220, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof (__assert_single_arg (stat == 0)), __extension__ ({ if (stat == 0) ; else __assert_fail ("stat == 0", "testapp.c", 2221, __extension__ __PRETTY_FUNCTION__); }));
    } else {
        con = connect_server("127.0.0.1", port, false, enable_ssl);
        ((void) sizeof (__assert_single_arg (con)), __extension__ ({ if (con) ; else __assert_fail ("con", "testapp.c", 2224, __extension__ __PRETTY_FUNCTION__); }));
 ...
 cleanup:
    ...
    ((void) sizeof (__assert_single_arg (kill(server_pid, 15) == 0)), __extension__ ({ if (kill(server_pid, 15) == 0) ; else __assert_fail ("kill(server_pid, SIGTERM) == 0", "testapp.c", 2248, __extension__ __PRETTY_FUNCTION__); }));
    return ret;
}
...
int main(int argc, char **argv)
{
    ...
    printf("1..%d\n", num_cases);
    for (ii = 0; testcases[ii].description != ((void *)0); ++ii) {
        fflush(stdout);
        alarm(600);
