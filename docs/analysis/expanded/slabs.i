...
static slabclass_t slabclass[(63 + 1)];
static size_t mem_limit = 0;
static size_t mem_malloced = 0;
static bool mem_limit_reached = false;
static int power_largest;
static void *mem_base = ((void *)0);
static void *mem_current = ((void *)0);
static size_t mem_avail = 0;
static pthread_mutex_t slabs_lock = { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { ((void *)0), ((void *)0) } } };
...
void slabs_init(const size_t limit, const double factor, const bool prealloc, const uint32_t *slab_sizes, void *mem_base_external, bool reuse_mem) {
    ...
    mem_limit = limit;
    if (prealloc && mem_base_external == ((void *)0)) {
    ...
    } else if (prealloc && mem_base_external != ((void *)0)) {
        do_slab_prealloc = true;
...
static void do_slabs_stats(ADD_STAT add_stats, void *c) {
    ...
    for(i = 1; i <= power_largest; i++) {
        ...
        if (p->slabs != 0) {
            ...
            char val_str[128];
            int klen = 0, vlen = 0;
            klen = snprintf(key_str, 128, "%d:%s", i, "chunk_size"); vlen = snprintf(val_str, 128, "%u", p->size); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "chunks_per_page"); vlen = snprintf(val_str, 128, "%u", perslab); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "total_pages"); vlen = snprintf(val_str, 128, "%u", slabs); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "total_chunks"); vlen = snprintf(val_str, 128, "%u", slabs * perslab); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "used_chunks"); vlen = snprintf(val_str, 128, "%u", slabs*perslab - p->sl_curr); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "free_chunks"); vlen = snprintf(val_str, 128, "%u", p->sl_curr); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "free_chunks_end"); vlen = snprintf(val_str, 128, "%u", 0); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "get_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].get_hits); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "cmd_set"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].set_cmds); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "delete_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].delete_hits); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "incr_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].incr_hits); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "decr_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].decr_hits); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "cas_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].cas_hits); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "cas_badval"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].cas_badval); add_stats(key_str, klen, val_str, vlen, c);;
            klen = snprintf(key_str, 128, "%d:%s", i, "touch_hits"); vlen = snprintf(val_str, 128, "%llu", (unsigned long long)thread_stats.slab_stats[i].touch_hits); add_stats(key_str, klen, val_str, vlen, c);;
            total++;
        }
    }
    append_stat("active_slabs", add_stats, c, "%d", total);;
    append_stat("total_malloced", add_stats, c, "%llu", (unsigned long long)mem_malloced);;
